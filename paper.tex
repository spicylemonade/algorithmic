...
\textbf{Laderman's Algorithm (1976).} Using bilinear decomposition techniques, Laderman \cite{laderman1976} achieved 23 multiplications with 60 additions/subtractions (83 total operations). This remains the best-known exact algorithm for minimizing multiplication count.
...
Laderman & 23 & 60 & 83 & \texttimes & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Laderman: 83 operations $> 81$ \texttimes
\end{itemize}
...
\text{Block-Strassen} & \text{if } 13 \leq \rho < 10.5 \\
\text{Laderman} & \text{if } \rho \geq 10.5
\end{cases}
\end{equation}
